...
QString aSoundPath; // Путь к крайнему открытому звуковому файлу

// Массив включенных/отключенных звуков в различных режимах
bool aAllSoundOn[3][3];
...
{
    aRabModeCurrentTS = RabModeCurrentTS;
}
